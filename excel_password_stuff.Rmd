...
## Make an eAPP
We need to create an object in R that can interact with excel files (or something). We do this by specifying class `Excel.Application` in the `RDCOMClient::COMCreate`.
